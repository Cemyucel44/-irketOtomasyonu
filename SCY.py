import sys  # Sistem modülünü içe aktarır
import pymysql.cursors  # MySQL veritabanı bağlantısı için modülü içe aktarır
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLabel, QLineEdit, QTextEdit, QInputDialog  # PyQt5 bileşenlerini içe aktarır
from PyQt5.QtCore import Qt  # PyQt5'in temel bileşenlerini içe aktarır
from datetime import datetime  # datetime modülünü içe aktarır
from pyzbar.pyzbar import decode  # QR kodu çözümleme için modülü içe aktarır
import cv2  # OpenCV modülünü içe aktarır
import random  # Rastgele sayılar üretmek için modülü içe aktarır
import string  # Dize işlemleri için modülü içe aktarır
...
class GirisCikisTakip(QWidget):
    ...
    def giris_yap(self, is_qr=False, gecis_kodu=None):
        ...
        try:
            ...
            db = pymysql.connect(host='127.0.0.1', user='root', password='123456789', db='bitirme', charset='utf8mb4', cursorclass=pymysql.cursors.DictCursor)
            baglanti = db.cursor()
